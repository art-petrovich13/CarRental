    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Бюджетные автомобили", "Economy" },
                    { 2, "Бизнес-класс", "Business" },
                    { 3, "Премиум-класс", "Premium" },
                    { 4, "Внедорожники", "SUV" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ivanov@carrental.ru", "Иванов Иван Иванович", new DateTime(2026, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc), "+375-29-111-22-33", "Менеджер" },
                    { 2, "petrova@carrental.ru", "Петрова Анна Сергеевна", new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Utc), "+375-44-444-55-66", "Администратор" }
                });
